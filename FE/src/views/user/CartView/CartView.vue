<template>
  <div class="container">
      ...
      <div class="col-md-5 px-3">
        <div class="card-block px-3">
          ...
          <p id="item-price" class="mb-0 font-weight-bold">
            {{ cartItem.product.price }}.000đ cho 1 sản phẩm
          </p>
          ...
          <p id="item-total-price" class="mb-0">
            ...
            <span class="font-weight-bold">
              {{ cartItem.product.price * cartItem.quantity }}.000đ</span
            >
          </p>
          <br /><a href="#" class="text-right" @click="deleteItem(cartItem.id)"
            >Xóa ra khỏi vỏ hàng</a
          >
        </div>
      </div>
      <div class="col-2"></div>
    ...
    <div class="total-cost pt-2 text-right">
      <h5>Tổng cộng: {{ totalcost.toFixed(0) }}.000đ</h5>
      <button
        :disabled="isDisabled()"
        type="button"
